...
この方法では、デ[バイス](http://d.hatena.ne.jp/keyword/%A5%D0%A5%A4%A5%B9)の回転をロックすると、検知されなくなります。（コン[トロール](http://d.hatena.ne.jp/keyword/%A5%C8%A5%ED%A1%BC%A5%EB)パネルにある、あれです！！）
...
※メソッド名は、[セレクタ](http://d.hatena.ne.jp/keyword/%A5%BB%A5%EC%A5%AF%A5%BF)で指定したメソッド名にしてください。
