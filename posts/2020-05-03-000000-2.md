...
本記事では、「[FloatingPanel](https://github.com/SCENEE/FloatingPanel)」のライブラリを使用させて頂き、セミモーダルビューを表示する方法をまとめています。
...
ソースコードは、[こちら](https://github.com/nakkann-1013/FloatingPanelSample_ios)にアップしていますので、とりあえず動かしてみたい方はクローンして確認してください。
