...
そのため、ここでは独自クラスを[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)して設定する方法を記載します。
...
※セキュリティの強い[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)をするためのフラグなので、おまじないだと思ってください。

```swift
static var supportsSecureCoding: Bool = true
```

[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)の関数「encode」を作成し、パラメータを[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)するコードを記載します。（詳細はソースを参照してください）
...
「forKey」の部分は[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)で利用したKeyを記載してください。
...
このままでは、「init?」関数の影響で、[インスタンス](http://d.hatena.ne.jp/keyword/%A5%A4%A5%F3%A5%B9%A5%BF%A5%F3%A5%B9)作成時に引数「NSCoder」が必要になってしまうので、[インスタンス](http://d.hatena.ne.jp/keyword/%A5%A4%A5%F3%A5%B9%A5%BF%A5%F3%A5%B9)作成用に空のinitメソッドを追加します。
...
「NSKeyedArchiver」クラスの「archivedData」関数を利用して[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)し、if letを利用して[エンコード](http://d.hatena.ne.jp/keyword/%A5%A8%A5%F3%A5%B3%A1%BC%A5%C9)されている場合にはUserDefaultsに保存する処理を記載してください。
