...
「[[秘密鍵](http://d.hatena.ne.jp/keyword/%C8%EB%CC%A9%B8%B0)]」と「[証明書]」の部分は各環境に書き換えてください。
...
「hogehoge.com」の部分は自分の[ドメイン](http://d.hatena.ne.jp/keyword/%A5%C9%A5%E1%A5%A4%A5%F3)に書き換えてください。

# ■HTTPSのポートを指定する方法

package.[json](http://d.hatena.ne.jp/keyword/json)の「scripts」を以下のように記載することで、HTTPと[HTTPS](http://d.hatena.ne.jp/keyword/HTTPS)のそれぞれのポートを指定できます。
...
「PORT」がHTTPのポートで「[SSL](http://d.hatena.ne.jp/keyword/SSL)_PORT」が[HTTPS](http://d.hatena.ne.jp/keyword/HTTPS)のポートです。
