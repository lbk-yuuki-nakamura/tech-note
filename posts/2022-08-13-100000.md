...
![](/images/2022-08-13-100000/20220806151626.png)

「`制限付きのキーを作成`」を押下します。

![](/images/2022-08-13-100000/20220806151715.png)

キーの名前に任意の名前を入力します。（何でもいいです）

![](/images/2022-08-13-100000/20220806151800.png)

「`Customers`」の権限を「`書き込み`」に変更します。

![](/images/2022-08-13-100000/20220806151956.png)

画面最下部の「`キーを作成`」を押下します。

「`テストキーを表示`」を押下して表示された「`トークン`」を後程利用するので、残しておいてください。

![](/images/2022-08-13-100000/20220806152127.png)
...
![](/images/2022-08-13-100000/20220806153740.png)
